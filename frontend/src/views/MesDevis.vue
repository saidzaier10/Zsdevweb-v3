            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div class="flex items-start justify-between mb-3">
                  <div>
                    <div class="flex items-center gap-2 mb-1">
                      <h3 class="text-xl font-semibold text-dark-800 dark:text-dark-100">
                        {{ quote.project_type?.name || 'N/A' }}
                      </h3>
                      <span v-if="quote.discount_amount && quote.discount_amount > 0" class="px-2 py-0.5 bg-green-100 dark:bg-green-900/20 text-green-700 dark:text-green-400 text-xs font-semibold rounded-full flex items-center gap-1">
              ...
              <div class="flex flex-col gap-2 lg:ml-4">
                ...
                <a
                  ...
                  target="_blank"
                  download
                  class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium transition-colors text-center flex items-center justify-center gap-2"
                >
