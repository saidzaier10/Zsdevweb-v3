...
from .mixins import ImageOptimizationMixin
...
class Project(ImageOptimizationMixin, models.Model):
    ...
    image_fields = {
        'thumbnail': {'max_width': 600, 'max_height': 400, 'quality': 85},
        'image_main': {'max_width': 1920, 'max_height': 1080, 'quality': 85}
    }
...
class ProjectImage(ImageOptimizationMixin, models.Model):
    ...
    image_fields = {
        'image': {'max_width': 1920, 'max_height': 1080, 'quality': 85}
    }
...
class Testimonial(ImageOptimizationMixin, models.Model):
    """Témoignages clients"""
    ...
    image_fields = {
        'client_photo': {'max_width': 400, 'max_height': 400, 'quality': 85}
    }
